...
"title": "MyBntg APIs", //Kasih namalu 
...
mimetype: "image/jpeg",
text: "ZackBntg Official",
"forwardingScore": 1000000000,
isForwarded: true,
sendEphemeral: true,
"externalAdReply": {
"title": `ZackBntg Official`,
"body": `Subscribe To Channel YouTube ZackBntg Official`,
"previewType": "PHOTO",
"thumbnailUrl": thum,
"thumbnail": thum,
"sourceUrl": "https://youtu.be/DzNIL45qHaM"
...
if (isBan) return m.reply(mess.ban)
if (!isCreator) return m.reply(mess.owner)
if (!args.join(" ")) return m.reply(`Text mana?\n\nExample : ${prefix + command} ZackBntg Official`)
...
let txt = `*「 Broadcast」*\n\n${text}`
sock.send5ButImg(i, txt, "© BNTGP02", log0, btn, thum)
}
...
let txt = `*「 Broadcast」*\n\n${text}`
sock.send5ButImg(yoi, txt, "© BNTGP02", log0, btn, thum)
}
...
headerType: 4,
contextInfo:{externalAdReply:{
title:"BNTGBOTZ -By Kurah updte🗿",
body:"© BNTGP02",
thumbnail: log0,
mediaType:2,
mediaUrl: "https://youtu.be/DzNIL45qHaM",
sourceUrl: "https://youtu.be/DzNIL45qHaM"
}}
}
sock.sendMessage(m.chat, buttonMessage, { quoted: m })
...
.then(async (data) => {
var asu = args.join(" ")
var dapamemek = data.display_url
let meme = `https://api.memegen.link/images/custom/ /${asu}.png?background=${dapamemek}`
...
// Antitag Via Tag ( BY MyBntg APIs )
